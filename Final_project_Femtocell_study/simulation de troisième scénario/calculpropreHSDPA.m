...
function [RatePerUs]= HsdpaRate(TxPwtot, TxPwPerUsdBm) 
...
XBs=[ 2/3,0,3/2*Radius, -3/2*Radius, 1*Radius, 1/2*Radius, -1/2*Radius ];
YBs=[ sqrt(1/4),0,sqrt(3)/2*Radius, sqrt(3)*Radius, -sqrt(3)/2*Radius, -sqrt(3)*Radius, -sqrt(3)/2*Radius ];
Bs(:,1)=XBs'; Bs(:,2)=YBs';
